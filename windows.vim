...
set pythondll=
set pythonhome=
set pythonthreehome=$HOME/vimrc/bin/win32/python39
set pythonthreedll=$HOME/vimrc/bin/win32/python39/python39.dll
let g:python3_host_prog = '~/vimrc/bin/win32/python39/python.exe'
